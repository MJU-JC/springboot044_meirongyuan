...
public class HuiyuanyuyuexinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public HuiyuanyuyuexinxiEntity() {
		
	}
	
	public HuiyuanyuyuexinxiEntity(T t) {
		try {
	 ...
	 * 设置：指定技师
	 */
	public void setZhidingjishi(String zhidingjishi) {
		this.zhidingjishi = zhidingjishi;
	}
	/**
	 * 获取：指定技师
	 */
	public String getZhidingjishi() {
		return zhidingjishi;
	}
	/**
	 * 设置：是否审核
