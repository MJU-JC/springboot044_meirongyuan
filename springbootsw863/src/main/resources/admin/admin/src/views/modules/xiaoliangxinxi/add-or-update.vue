<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="销售时长" prop="xiaoshoushizhang">
          <el-input v-model="ruleForm.xiaoshoushizhang" 
              placeholder="销售时长" clearable  :readonly="ro.xiaoshoushizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="销售时长" prop="xiaoshoushizhang">
              <el-input v-model="ruleForm.xiaoshoushizhang" 
                placeholder="销售时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.meirongpinming = true;
          ...
          if(o=='xiaoshoushizhang'){
            this.ruleForm.xiaoshoushizhang = obj[o];
	    this.ro.xiaoshoushizhang = true;
            continue;
          }
          if(o=='xiaoshouliang'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xiaoliangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaoliangxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
