<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="前台账号" prop="qiantaizhanghao">
          <el-select  @change="qiantaizhanghaoChange" v-model="ruleForm.qiantaizhanghao" placeholder="请选择前台账号">
            <el-option
                v-for="(item,index) in qiantaizhanghaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.qiantaizhanghao" label="前台账号" prop="qiantaizhanghao">
              <el-input v-model="ruleForm.qiantaizhanghao" 
                placeholder="前台账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="前台姓名" prop="qiantaixingming">
          <el-input v-model="ruleForm.qiantaixingming" 
              placeholder="前台姓名" clearable  :readonly="ro.qiantaixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="前台姓名" prop="qiantaixingming">
              <el-input v-model="ruleForm.qiantaixingming" 
                placeholder="前台姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="拉拢客户人数" prop="lalongkehurenshu">
          <el-input v-model="ruleForm.lalongkehurenshu" 
              placeholder="拉拢客户人数" clearable  :readonly="ro.lalongkehurenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="拉拢客户人数" prop="lalongkehurenshu">
              <el-input v-model="ruleForm.lalongkehurenshu" 
                placeholder="拉拢客户人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="年业绩额" prop="nianyejie">
          <el-input v-model="ruleForm.nianyejie" 
              placeholder="年业绩额" clearable  :readonly="ro.nianyejie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="年业绩额" prop="nianyejie">
              <el-input v-model="ruleForm.nianyejie" 
                placeholder="年业绩额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	qiantaizhanghao : false,
	qiantaixingming : false,
	xingbie : false,
	lalongkehurenshu : false,
	nianyejie : false,
      },
      ruleForm: {
        qiantaizhanghao: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='qiantaizhanghao'){
            this.ruleForm.qiantaizhanghao = obj[o];
	    this.ro.qiantaizhanghao = true;
            continue;
          }
          if(o=='qiantaixingming'){
            this.ruleForm.qiantaixingming = obj[o];
	    this.ro.qiantaixingming = true;
            continue;
          }
          if(o=='xingbie'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='lalongkehurenshu'){
            this.ruleForm.lalongkehurenshu = obj[o];
	    this.ro.lalongkehurenshu = true;
            continue;
          }
          if(o=='nianyejie'){
            this.ruleForm.nianyejie = obj[o];
	    this.ro.nianyejie = true;
            continue;
          }
        }
      }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/qiantai/qiantaizhanghao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.qiantaizhanghaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    // 下二随
    qiantaizhanghaoChange () {
      this.$http({
        url: `follow/qiantai/qiantaizhanghao?columnValue=`+ this.ruleForm.qiantaizhanghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.qiantaixingming){
                this.ruleForm.qiantaixingming = data.data.qiantaixingming
              }
    ...
    info(id) {
      this.$http({
        url: `qiantainianyejitongji/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qiantainianyejitongji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qiantainianyejitongjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
